...
document.writeln("<div id=\"_contents\" style=\"padding:6px; background-color:#fff; font-size: 12px; border: 1px solid #777777; position:absolute; left:?px; top:?px; width:?px; height:?px; z-index:1; visibility:hidden\">");

str += "\u65f6<select class=\"input-mini\" id=\"_hour\">";
...
str += "</select> \u5206<select class=\"input-mini\" id=\"_minute\">";
...
// 隐藏秒
/*
str += "</select> \u79d2<select class=\"input-mini\" id=\"_second\">";
