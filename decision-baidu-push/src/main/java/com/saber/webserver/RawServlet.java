...
//		String token = servlet.fetchToken("http request:GET /bcms/accept_sub?destination=http://127.0.0.1:8080/rest&queue_name=24d27fa9a5451eb93ff8755cff90bb63&token=3a6ac580aec6e21902a9e00ac5dece61 HTTP/1.1");
