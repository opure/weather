...
public class SmsVerifyKit {
	...
	public static void main(String[] args) throws Exception {
		...
		//new SmsVerifyKit("appkey", "phone", "zone", "code").go();
		//System.out.println(new SmsVerifyKit("6048822345e1", "18663184382", "86", "1721").go());
		System.out.println(new SmsVerifyKit("7c175d781ead", "18663184382", "86", "5699").go());
