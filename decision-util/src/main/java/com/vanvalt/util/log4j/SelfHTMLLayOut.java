package com.vanvalt.util.log4j;
...
public class SelfHTMLLayOut extends HTMLLayout {
	...
	public String format(LoggingEvent event) {
		...
		this.sbuf.append(event.getMDC(IP));
		this.sbuf.append(" ");
		...
		if (event.getLevel().equals(Level.DEBUG)) {
			...
			this.sbuf.append(Transform.escapeTags(String.valueOf(event
					.getLevel())));
		...
		if (event.getNDC() != null) {
			this.sbuf
					.append("<tr><td bgcolor=\"#EEEEEE\" style=\"font-size : medium ;\" colspan=\"6\" title=\"Nested Diagnostic Context\">");
		...
		if (s != null) {
			this.sbuf
					.append("<tr><td bgcolor=\"#993300\" style=\"color:White; font-size : medium ;\" colspan=\"6\">");
	...
	public String getHeader() {
		...
		sbuf.append("<!--" + Layout.LINE_SEP);
		sbuf.append("body, table {font-family: arial,sans-serif; font-size: medium ;}"
				+ Layout.LINE_SEP);
